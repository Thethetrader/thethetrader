...
const LEARNING_TILES: { src: string; kind: "img" | "video"; poster?: string }[] = [
  { src: "/alti-images/ecosystem/signals-schema-course-slide.webp", kind: "img" },
  {
    src: "/alti-videos/ecosystem/trading-graph-quentin.webm",
    kind: "video",
    poster: "/alti-videos/ecosystem/trading-graph-quentin-poster.webp",
  },
  { src: "/alti-images/ecosystem/course-quiz-score.webp", kind: "img" },
  { src: "/alti-images/ecosystem/time-units-course-slide.webp", kind: "img" },
  {
    src: "/alti-videos/ecosystem/fixytrade-alexandre.webm",
    kind: "video",
    poster: "/alti-videos/ecosystem/fixytrade-alexandre-poster.webp",
  },
  { src: "/alti-images/ecosystem/learning-plateform.webp", kind: "img" },
  { src: "/alti-images/ecosystem/trading-score-course-slide.webp", kind: "img" },
  {
    src: "/alti-videos/ecosystem/bootcamp-conf-alexandre.webm",
    kind: "video",
    poster: "/alti-videos/ecosystem/bootcamp-conf-alexandre-poster.webp",
  },
  { src: "/alti-images/ecosystem/start-course-slide.webp", kind: "img" },
];
          ...
          <div style={{ flex: "0 0 768px", position: "relative" }}>
            ...
            >
              ...
              <CenteredImageVisual
                ...
                pillar="coachings"
                src="/alti-images/ecosystem/coaching-ind-cam-view@2x.webp"
                width={532}
                height={640}
              ...
              <CenteredImageVisual
                ...
                pillar="community"
                src="/alti-images/ecosystem/discord-chat-feed@2x.webp"
                width={450}
                height={725}
              ...
              <CenteredImageVisual
                ...
                pillar="resources"
                src="/alti-images/ecosystem/tools-ui-blocks@2x.webp"
                width={615}
                height={700}
            ...
            return (
              <div key={pillar}>
                <div
                  style={{
                    position: "relative",
                    height: pillar === "learning" ? 600 : 420,
                    background: PILLAR_BG[pillar],
                    borderRadius: 24,
                    overflow: "hidden",
                    marginBottom: pillar === "learning" ? 0 : 32,
                    padding: pillar === "learning" ? 32 : 0,
                    display: pillar === "learning" ? "flex" : "block",
                    flexDirection: pillar === "learning" ? "column" : undefined,
                    justifyContent: pillar === "learning" ? "center" : undefined,
                  }}
                >
                  {pillar === "learning" ? (
                    <div
                  ...
                  ) : pillar === "coachings" || pillar === "community" || pillar === "resources" ? (
                    <div
                      style={{
                        position: "absolute",
                        inset: 0,
                    ...
                    >
                      <Image
                        src={
                          pillar === "coachings"
                            ? "/alti-images/ecosystem/coaching-ind-cam-view@2x.webp"
                            : pillar === "community"
                              ? "/alti-images/ecosystem/discord-chat-feed@2x.webp"
                              : "/alti-images/ecosystem/tools-ui-blocks@2x.webp"
                        }
                        alt=""
