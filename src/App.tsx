              ...
              <div className="w-screen -mx-4 sm:mx-0 sm:w-full">
                <div className="flex justify-center relative">
                  ...
                  <img 
                    ...
                    className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-32 h-48 sm:w-36 sm:h-48 object-cover rounded-lg shadow-lg border-2 border-white/30"
                  />
                </div>
              </div>
