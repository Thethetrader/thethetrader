        ...
        <>
          ...
          <div className="text-center pt-20 sm:pt-32 pb-0 px-4 sm:px-6">
            ...
            <div id="services" className="w-full mb-10 sm:mb-16">
              ...
              {/* Section Automated Journaling avec numéro 1 */}
              <div className="max-w-7xl mx-auto px-4 sm:px-6 mt-16">
                <div className="relative">
                  {/* Numéro 1 en haut à gauche */}
                  <div className="absolute -top-8 -left-8 text-8xl font-bold text-purple-300/30 select-none">
                    1
                  </div>
                  ...
                  <div className="text-center mb-8">
                    ...
                    <h2 className="text-4xl md:text-6xl font-bold mb-6">
                      <span className="text-gray-700">Powerful and Automated</span>
                      <br />
                    ...
                    <p className="text-gray-600 text-lg max-w-2xl mx-auto mb-8">
                      ...
                      With automated journaling, we do the heavy lifting for you.
                    </p>
                    <button className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-4 rounded-lg font-semibold hover:opacity-90 transition-opacity">
                      View all brokers & integrations >
                    </button>
                  </div>
                  ...
                  <div className="flex flex-wrap justify-center items-center gap-8 mb-16">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-gray-600 font-medium">NINJATRADER</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <div className="w-8 h-8 bg-red-600 rounded flex items-center justify-center">
                        <span className="text-white font-bold text-xs">IB</span>
                      </div>
                      <span className="text-gray-600 font-medium">InteractiveBrokers</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <div className="w-8 h-8 bg-green-600 rounded flex items-center justify-center">
                        <span className="text-white font-bold text-xs">TD</span>
                      </div>
                      <span className="text-gray-600 font-medium">TD Ameritrade</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center">
                        <span className="text-white font-bold text-xs">4</span>
                      </div>
                      <span className="text-gray-600 font-medium">MetaTrader 4</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <div className="w-8 h-8 bg-blue-600 rounded flex items-center justify-center">
                        <span className="text-white font-bold text-xs">T</span>
                      </div>
                      <span className="text-gray-600 font-medium">tradovate</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center">
                        <span className="text-white font-bold text-xs">W</span>
                      </div>
                      <span className="text-gray-600 font-medium">Webull</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 mt-16">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {/* Carte 1: Journal Automatisé */}
                  <div className="bg-gradient-to-br from-purple-600 to-pink-600 rounded-xl p-6 shadow-xl">
                    <h3 className="text-xl font-bold text-white mb-4">Journal Automatisé</h3>
                    <p className="text-white/90 mb-6">Enregistrez vos trades facilement avec synchronisation automatique, import de fichiers ou saisie manuelle.</p>
                    <div className="bg-white/10 rounded-lg p-4 text-center">
                      <div className="flex justify-center space-x-4 mb-4">
                        <button className="bg-white/20 text-white px-4 py-2 rounded-lg text-sm">CONNECTER</button>
                        <button className="bg-white/20 text-white px-4 py-2 rounded-lg text-sm">+ Importer</button>
                      </div>
                      <div className="flex justify-center space-x-2">
                        <div className="w-8 h-8 bg-red-500 rounded-full flex items-center justify-center text-white text-xs font-bold">6</div>
                        ...
                        <div className="w-8 h-8 bg-yellow-500 rounded-full flex items-center justify-center text-white text-xs font-bold">5</div>
                      </div>
                    </div>
                  </div>

                  {/* Carte 2: Comptes Illimités */}
                  <div className="bg-gradient-to-br from-purple-600 to-pink-600 rounded-xl p-6 shadow-xl">
                    <h3 className="text-xl font-bold text-white mb-4">Comptes Illimités</h3>
                    <p className="text-white/90 mb-6">Gérez un nombre illimité de comptes de trading, tous connectés en un seul endroit.</p>
                    <div className="bg-white/10 rounded-lg p-4">
                      <div className="mb-3">
                        <select className="w-full bg-white/20 text-white rounded-lg px-3 py-2 text-sm">
                          <option>Tous les Comptes</option>
                          <option>Compte Principal</option>
                          <option>MFF</option>
                          <option>Compte Demo</option>
                        </select>
                      </div>
                      ...
                      <div className="mt-4 text-xs text-white/60">
                        P&L Cumulatif Quotidien
                      </div>
                    </div>
                  </div>

                  {/* Carte 3: Statistiques Automatisées */}
                  <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-xl p-6 shadow-xl">
                    <h3 className="text-xl font-bold text-white mb-4">Statistiques Automatisées</h3>
                    <p className="text-white/90 mb-6">Plus de calculs manuels. Vos statistiques de trading présentées automatiquement.</p>
                    <div className="bg-white/10 rounded-lg p-4">
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        <div className="text-white/80">
                          <div className="font-semibold">Solde</div>
                          <div className="text-green-400">$32,032.50</div>
                        </div>
                        <div className="text-white/80">
                          <div className="font-semibold">P&L</div>
                          <div className="text-green-400">+$7,032.50</div>
                        </div>
                        <div className="text-white/80">
                      ...
                      <div className="mt-4 text-xs text-white/60 text-center">
                        Analyse des Pertes Automatique
                      </div>
                    </div>
                  </div>
                </div>
